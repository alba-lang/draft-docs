...
\paragraph{Completeness of inner nodes}
%
\begin{center}
    \begin{tabular}{l p{6cm}}
        $[x \mid t]$ & always complete
        %
        \\
        $[x \mid c_1 t_1, \ldots, c_n t_n \mid d]$
        & complete if it has a default tree
        %
        \\
        $[x \mid \ell_1 t_1, \ldots, \ell_n t_n \mid d]$
        & complete if all constructors labels are present or if it has a
        default tree
    \end{tabular}
\end{center}
